...
# Read the word count data from "combined_wc1spark.txt"
wordcount <- read_delim("/Users/jiene/OneDrive/Desktop/Spark/combine_wc1spark.txt", 
...
# Filter the data to include only words with a count greater than 5000
filtered_wordcount <- subset(wordcount, Count > 5000)
