...
# Read the word count data from "5_mrjob_wordcount_result.txt"
wordcount <- read_delim("/Users/jiene/OneDrive/Desktop/Hive and MrJob/5_mrjob_wordcount_result.txt", 
